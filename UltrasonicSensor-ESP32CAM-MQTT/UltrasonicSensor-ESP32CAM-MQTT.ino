 ...
 * 
 * Este programa lee el sensor ultrasonico HC-SR04 con la biblioteca Ultrasonic de Erick Simoes v3.0.0.
 * Programa base: ESP32CAM-MQTT-Basic del repositorio Codigo-IoT
 * 
 * Este programa envia datos por internetatraves del protocolo MQTT. Para poder
 ...
 * HC-SR04-VCC----FTDI-VCC
 * HC-SR04-GND----FTDI-GND
 * HC-SR04-ECHO---GPIO 2
 * HC-SR04 TRIGG--GPIO 12
 */
...
//Datos de WiFi
const char* ssid = "ATT_RGB";
const char* password = "7J51F1JGT70";
...
void loop() {
  ...
  if (timeNow - timeLast > wait) { // Manda un mensaje por MQTT cada cinco segundos
    ...
    distance = ultrasonic.read();//la variable para ser enviado por MQTT
    ...
    client.publish("codigoiot/distancia/ricardogodinez", dataString); // Esta es la función que envía los datos por MQTT, especifica el tema y el valor
